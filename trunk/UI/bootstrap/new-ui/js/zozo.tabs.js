...
(function ($, window, document, undefined) {
    ...
    ZozoTabs.prototype = {
        ...
        play: function (interval) {
            ...
            _base.stop();
            _base.autoplayIntervalId = setInterval(function () {
                _base.next(_base);
            }, _base.settings.autoplay.interval);
        ...
        checkPosition: function (_base) {
            ...
            if (_base.settings.orientation === zozo.classes.orientations.vertical) {
                ...
                switch (_base.settings.size) {
                    case zozo.classes.sizes.mini:
                        _height = 33;
                        break;
                    case zozo.classes.sizes.small:
                        _height = 39;
                        break;
                    case zozo.classes.sizes.medium:
                        _height = 45;
                        break;
                    case zozo.classes.sizes.large:
                        _height = 51;
                        break;
                    case zozo.classes.sizes.xlarge:
                        _height = 57;
                        break;
                    case zozo.classes.sizes.xxlarge:
                        _height = 63;
                        break;
                    default:
                        _height = 45;
